            ...
            <div className="footer_links">
                <div className="footer_link_column bee_dev">
                    <p>
                        Website Built By:
                        <br />
                        <FooterLink_atag href="https://beedev-services.com/" text="BEEDEV-SERVICES" aria={ "Built By BeeDev [Learn more...]" } />
                    </p>
                    <span className="footer_spacer"></span> 
                    <p>
                        Powered By:
                        <br />
                        <FooterLink_atag href="https://techbyte-learning.com/" text="TechByte Learning" aria={ "Taught By TechByte Learning [Learn more...]" } />
                    </p>
                </div>
                <div className="footer_link_column">
                    <FooterLink href="/location" text="Hours & Location" aria={ "Click To View Hours And Location" } />
                    <FooterLink href="/menu" text="Menu" aria={ "View Our Menu" } />
                    <FooterLink href="/aboutus" text="About Us" aria={ "About Us [Learn more...]" } />
                    {/* <FooterLink href="/#" text="Order Online" /> */}
                    {/* Footer Socials */}
                    <div className="footer_socials">
                        {/* Facebook */}
                        <a href="https://www.facebook.com/people/Seoul-Kitchen-Grand-Forks/61558224505864" target="_blank" aria-label="Follow Us On Facebook">
                            <i className="fa-brands fa-facebook-square"></i>
                        </a>
                        {/* Twitter */}
                        {/* <a href="#add_a_link" target="_blank" aria-label="Follow Us On Twitter">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/seoulkitchengf/" target="_blank" aria-label="Follow Us On Instagram">
                            <i className="fa-brands fa-instagram"></i>
                        </a>
                        {/* Mail */}
                        <Link to="/location"  aria-label="Our Contact Info [Learn more...]">
